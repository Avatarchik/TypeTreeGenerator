...
namespace TypeTreeGenerator
{
	public sealed class TypeDefinition
	{
		...
		public void Export(TextWriter writer, TypeDefinition root)
		{
			...
			if(this == root)
			{
				writer.WriteLine($"namespace UnityRipper.Classes");
			}
			else
			{
				writer.WriteLine($"namespace UnityRipper.Classes.{root.Name}s");
			}
			writer.WriteLine('{');
			if(this == root)
			{
		...
		private void ExportUsings(TextWriter writer, TypeDefinition root)
		{
			...
			writer.WriteLine($"using UnityRipper.AssetExporters;");
			if(this == root)
			{
				writer.WriteLine($"using UnityRipper.Classes.{root.Name}s;");
			}
			writer.WriteLine($"using UnityRipper.Exporter.YAML;");
			writer.WriteLine();
		}
